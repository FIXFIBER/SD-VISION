...
This scaffold was generated with `npm`. Use `npm` commands in this project unless you intentionally migrate the tooling.
...
- Apply local migrations: `npm run migrate:local`
- Create a new migration and apply it locally: `npm run makemigration -- --name <change-name>`
